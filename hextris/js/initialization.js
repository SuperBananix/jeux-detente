$(document).ready(function() {
	// RevisionApp (24/09/2026) : dans l'app, on attend le record gardé dans le
	// Google Sheet avant de démarrer (voir pont_app.js). Hors de l'app : immédiat.
	window.pontApp.demarrerApresSynchro(function () { initialize(); });
});
function initialize(a) {
	...
	if (a != 1) {
		...
		addKeyListeners();
		// RevisionApp (24/09/2026) : Google Analytics retiré.

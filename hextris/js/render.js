...
function renderBeginningText() {
    ...
    if(/mobile|Mobile|iOS|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        mob = true;
        input_text = 'Touche la gauche ou la droite'
        action_text = 'de l\'écran pour tourner'
        score_text = '3 blocs pareils = des points'
        fontSize = 35
    } else {
        mob = false
        input_text = 'Flèches gauche et droite'
        action_text = 'pour tourner l\'hexagone'
        score_text = '3 blocs pareils = des points !'
        fontSize = 27
    }
